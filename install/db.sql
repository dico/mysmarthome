...
(2, 'url', '', 'Full domain path. End with slash'),
(3, 'absolute_path', '', 'Full serverpath. End with slash.'),
(4, 'language_default', 'en_GB', ''),
(5, 'theme_desktop', 'msh2015', ''),
(6, 'email_address_sender', 'noreply@mysmarthome.no', ''),
(7, 'email_address_reply', 'noreply@mysmarthome.no', ''),
(8, 'time_outdated_value', '60', 'In minutes');
...
CREATE TABLE IF NOT EXISTS `msh_devices` (
  ...
  KEY `device_ext_id` (`device_ext_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Tabellstruktur for tabell `msh_devices_current_values`
--

CREATE TABLE IF NOT EXISTS `msh_devices_current_values` (
  `device_int_id` int(11) NOT NULL,
...
--
-- Indexes for table `msh_devices_current_values`
--
ALTER TABLE `msh_devices_current_values`
  ADD PRIMARY KEY (`device_int_id`,`unit_id`);
...
CREATE TABLE IF NOT EXISTS `msh_devices_has_methods` (
...
CREATE TABLE IF NOT EXISTS `msh_devices_has_units` (
  `device_int_id` int(11) NOT NULL,
  `unit_id` int(11) NOT NULL,
  PRIMARY KEY (`device_int_id`,`unit_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `msh_events` (
  ...
  `if_home_status` enum('','home','away','night') NOT NULL,
  `set_home_status` enum('','home','away','night') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `msh_events_triggers` (
  ...
  `unit_id` smallint(6) NOT NULL,
  `value` float NOT NULL,
  `time_range` int(11) NOT NULL COMMENT 'Not changed in this timerange',
...
--
-- Tabellstruktur for tabell `msh_event_log`
--

CREATE TABLE IF NOT EXISTS `msh_event_log` (
  `id` int(11) NOT NULL,
  `time` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `msh_methods` (
  `m_id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(64) NOT NULL,
  `cmd` varchar(32) NOT NULL,
  `support_value` tinyint(1) NOT NULL COMMENT 'Input value. 1=yes',
  PRIMARY KEY (`m_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dataark for tabell `msh_methods`
--

INSERT INTO `msh_methods` (`m_id`, `title`, `cmd`, `support_value`) VALUES
(1, 'On', 'turnOn', 0),
(2, 'Off', 'turnOff', 0),
(3, 'Dim', 'dim', 1),
(4, 'Bell', 'bell', 0),
(5, 'Value/Sensor', 'value', 0);
...
CREATE TABLE IF NOT EXISTS `msh_users` (
  ...
  `apikey_write` varchar(256) NOT NULL,
